    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.relationFK_TBLOGRETMENLER_TBLDERSLER = new global::System.Data.DataRelation("FK_TBLOGRETMENLER_TBLDERSLER", new global::System.Data.DataColumn[] {
                        this.tableTBLDERSLER.DERSIDColumn}, new global::System.Data.DataColumn[] {
                        this.tableTBLOGRETMENLER.OGRTBRANSColumn}, false);
        ...
        public partial class TBLOGRETMENLERDataTable : global::System.Data.TypedTableBase<TBLOGRETMENLERRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TBLOGRETMENLERRow AddTBLOGRETMENLERRow(byte OGRTID, TBLDERSLERRow parentTBLDERSLERRowByFK_TBLOGRETMENLER_TBLDERSLER, string OGRTADSOYAD) {
                ...
                if ((parentTBLDERSLERRowByFK_TBLOGRETMENLER_TBLDERSLER != null)) {
                    columnValuesArray[1] = parentTBLDERSLERRowByFK_TBLOGRETMENLER_TBLDERSLER[0];
                }
...
namespace BONUSPROJE1.DataSet1TableAdapters {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "INSERT INTO TBLOGRENCILER\r\n                         (OGRAD, OGRSOYAD, OGRKULUP, O" +
                "GRCINSIYET)\r\nVALUES        (@OGRAD,@OGRSOYAD,@OGRKULUP,@OGRCISIYET)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@OGRCISIYET", global::System.Data.SqlDbType.VarChar, 5, global::System.Data.ParameterDirection.Input, 0, 0, "OGRCINSIYET", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = @"SELECT        TBLOGRENCILER.OGRID, TBLOGRENCILER.OGRAD, TBLOGRENCILER.OGRSOYAD, TBLKULUPLER.KULUPAD, TBLOGRENCILER.OGRCINSIYET
FROM            TBLOGRENCILER INNER JOIN
                         TBLKULUPLER ON TBLOGRENCILER.OGRKULUP = TBLKULUPLER.KULUPID
WHERE        (tblogrencıler.ograd = @ograd)";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ograd", global::System.Data.SqlDbType.Variant, 1024, global::System.Data.ParameterDirection.Input, 0, 0, "", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            ...
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ogrıd", global::System.Data.SqlDbType.Variant, 1024, global::System.Data.ParameterDirection.Input, 0, 0, "", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._commandCollection[4] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[4].Connection = this.Connection;
            this._commandCollection[4].CommandText = "DELETE FROM TBLOGRENCILER\r\nWHERE        (ogrıd = @ogrıd)";
            this._commandCollection[4].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[4].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ogrıd", global::System.Data.SqlDbType.Variant, 1024, global::System.Data.ParameterDirection.Input, 0, 0, "", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual DataSet1.DataTable1DataTable ogrencılistesi() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, false)]
        public virtual int OGRENCIEKLE(string OGRAD, string OGRSOYAD, global::System.Nullable<byte> OGRKULUP, string OGRCISIYET) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            if ((OGRAD == null)) {
                command.Parameters[0].Value = global::System.DBNull.Value;
            }
            ...
            if ((OGRCISIYET == null)) {
                ...
                command.Parameters[3].Value = ((string)(OGRCISIYET));
            }
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual object ogrencigetir(object ograd) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[2];
            if ((ograd == null)) {
                throw new global::System.ArgumentNullException("ograd");
            }
            else {
                command.Parameters[0].Value = ((object)(ograd));
            }
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, false)]
        public virtual int ogrenciguncelle(string ograd, string ogrsoyad, global::System.Nullable<byte> ogrkulup, string ogrcinsiyet, object ogrıd) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[3];
            if ((ograd == null)) {
                command.Parameters[0].Value = global::System.DBNull.Value;
            }
            ...
            if ((ogrıd == null)) {
                throw new global::System.ArgumentNullException("ogrıd");
            }
            else {
                command.Parameters[4].Value = ((object)(ogrıd));
            }
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, false)]
        public virtual int ogrencisil(object ogrıd) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[4];
            if ((ogrıd == null)) {
                throw new global::System.ArgumentNullException("ogrıd");
            }
            else {
                command.Parameters[0].Value = ((object)(ogrıd));
            }
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
...
SELECT NOTID, DERSID, OGRID, SINAV1, SINAV2, SINAV3, PROJE, ORTALAMA, DURUM FROM TBLNOTLAR WHERE (NOTID = @NOTID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        NOTID, DERSID, OGRID, SINAV1, SINAV2, SINAV3, PROJE, ORTALAMA, DURU" +
                "M\r\nFROM            TBLNOTLAR\r\nWHERE        (ogrıd = @ogrıd)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ogrıd", global::System.Data.SqlDbType.Variant, 1024, global::System.Data.ParameterDirection.Input, 0, 0, "", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(DataSet1.TBLNOTLARDataTable dataTable, object ogrıd) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((ogrıd == null)) {
                throw new global::System.ArgumentNullException("ogrıd");
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((object)(ogrıd));
            }
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual DataSet1.TBLNOTLARDataTable notlistesi(object ogrıd) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((ogrıd == null)) {
                throw new global::System.ArgumentNullException("ogrıd");
            }
...
SELECT OGRTID, OGRTBRANS, OGRTADSOYAD FROM TBLOGRETMENLER WHERE (OGRTID = @OGRTID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        TBLOGRETMENLER.*\r\nFROM            TBLOGRETMENLER";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual DataSet1.TBLOGRETMENLERDataTable ogretmengetir() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        public virtual int FillBy(DataSet1.TBLOGRETMENLERDataTable dataTable) {
        ...
        public virtual DataSet1.TBLOGRETMENLERDataTable ogrgetir() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            DataSet1.TBLOGRETMENLERDataTable dataTable = new DataSet1.TBLOGRETMENLERDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
